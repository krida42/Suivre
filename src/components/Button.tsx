...
export const Button = ({ children, variant = "primary", size = "default", className = "", onClick, disabled, isLoading }: any) => {
  const baseStyle =
  ...
  return (
    <button className={`${baseStyle} ${sizes[size]} ${variants[variant]} ${className}`} onClick={onClick} disabled={disabled || isLoading}>
